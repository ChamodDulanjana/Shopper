...
const Offers = () => {
    return (
        <div className="w-[80%] h-[60vh] flex m-auto px-24 mb-10 bg-gradient-to-b from-pink-300 via-pink-200 to-pink-0 ...
        mt-5 max-lg:h-[45vh] max-lg:px-16 max-lg:gap-5 max-[460px]:px-10">
